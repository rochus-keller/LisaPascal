...
void Parser::SynErr(int n, const char* ctx) {
    ...
    {
       SynErr(d_next.d_lineNr, d_next.d_colNr, n, ctx);
    }
	errDist = 0;
}
...
void Parser::SemErr(const char* msg) {
	if (errDist >= minErrDist)
		error(d_cur.d_lineNr, d_cur.d_colNr, msg);
	errDist = 0;
}
...
void Parser::SynErr(int line, int col, int n, const char* ctx, const QString& str ) {
	QString s;
	QString ctxStr;
	if( ctx )
